...
export function WhatsAppButton({
  ...
  return (
    <a
      className={`inline-flex items-center gap-2 ${sizeClasses[size]} bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-bold tracking-widest uppercase rounded-sm shadow transition-all ${className}`}
      href={href}
      target="_blank"
