        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <div className="space-y-2 text-xs text-muted leading-relaxed">
              ...
              <p><strong className="text-ink">WhatsApp:</strong> <a className="hover:text-brick transition-colors text-emerald-700 font-semibold" href={siteConfig.footer.contact.whatsapp} target="_blank" rel="noopener noreferrer">Chat with us ({siteConfig.contact.phoneDisplay})</a></p>
            </div>
          </div>
        </div>
